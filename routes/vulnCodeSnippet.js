...
export const retrieveCodeSnippet = async (challengeKey) => {
...
export const serveCodeSnippet = () => async (req, res, next) => {
    try {
...
export const getVerdict = (vulnLines, neutralLines, selectedLines) => {
...
export const checkVulnLines = () => async (req, res, next) => {
